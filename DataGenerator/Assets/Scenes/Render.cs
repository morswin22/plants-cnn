...
public class Render : MonoBehaviour
{
    ...
    IEnumerator CaptureAndSaveFrames()
    {
        while (true)
        {
            ...
            var offscreenTexture = new Texture2D(textureCamera.GetComponent<Camera>().targetTexture.width, textureCamera.GetComponent<Camera>().targetTexture.height, TextureFormat.RGB24, false);
    ...
    void Start()
    {
        ...
        var rect = new Rect(0, 0, textureCameraSize.x , textureCameraSize.y);
        var renderTexture = new RenderTexture(textureCameraSize.x, textureCameraSize.y, 24);
